class IdeoElems:
    ...
    img_elems: str = (
        "//div[contains(@class, 'MuiGrid-root MuiGrid-container css-1yek722')]/div"
    )

    ratio_elem: str = "//div[@class='MuiBox-root css-ritwfp']/div[2]"
    ratio_elem_width_clickable: str = (
        "(//p[@class='MuiTypography-root MuiTypography-body1 css-1t1m8m6'])[1]"
    )
    ...
    image_num_elem_btn: str = (
        "//div[@class='MuiToggleButtonGroup-root css-1mfgcko']/button[{image_num}]"
    )
